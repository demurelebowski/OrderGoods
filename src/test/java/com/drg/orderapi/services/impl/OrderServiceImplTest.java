...
public class OrderServiceImplTest {
	...
	public void testDeleteNotPaidOrdersOlderThanTenMinutesException() {
		...
		when(orderRepository.findExpiredNotPaidOrders(tenMinutesAgo)).thenThrow(new RuntimeException());

		assertDoesNotThrow(() -> orderService.deleteExpiredNotPaidOrders());
	}
	...
	public void testDeleteNotPaidOrdersOlderThanTenMinutes() {
		...
		when(orderRepository.findExpiredNotPaidOrders(any(Instant.class))).thenReturn(unpaidOrders);
	...
	public void testDeleteNotPaidOrdersOlderThanTenMinutes_NoOrdersToDelete() {
		List<Order> orders = new ArrayList<>();
		when(orderRepository.findExpiredNotPaidOrders(any(Instant.class))).thenReturn(orders);
