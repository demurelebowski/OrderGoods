...
public class ClientController {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "OK."), @ApiResponse(responseCode = "404", description = "Client not found.") })
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Deleted with success."),
			@ApiResponse(responseCode = "404", description = "Client not found."), @ApiResponse(responseCode = "400", description = "Problem with request.") })
